		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-danger" href="Regusers.php" target="_self">View Registered Users</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					...
					<a class="btn btn-success" href="view_issued_book.php" target="_self">View Issued Books</a>
				</div>
			</div>
		</div>
